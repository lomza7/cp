...
| `docs/02-socle.md` | Ce qui a été construit en Phase 2, mesures, bugs corrigés |
| `docs/planche-da.html` | Planche de direction artistique, les quatre pistes évaluées |
| `QUESTIONS-CLIENT.md` | Les 25 informations à obtenir avant la mise en ligne |
...
Budget tenu : **953 octets de JavaScript compressé** sur la page d'accueil.
